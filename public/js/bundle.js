...
var HomeActions = function () {
  ...
  _createClass(HomeActions, [{
    key: 'getTwoCharacter',
    value: function getTwoCharacter() {
      var _this = this;
    ...
    value: function vote(winner, loser) {
      ...
      $.ajax({
        ...
        _this2.actions.getTwoCharacter();
      }).fail(function (jqXhr) {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { href: 'https://github.com/bonz027/eden-faces' },
                  'Source Code'
                ),
...
var AddCharacterStore = function () {
  function AddCharacterStore() {
    ...
    this.name = '';
    this.gender = '';
    // displays staus message below text field
    this.helpBlock = '';
